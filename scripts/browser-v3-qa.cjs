async (page) => {
  ...
  assert(
    await read(() => window.__NOL.game.scene.getScene("Survival").crouching),
    "Crouch persists after CTRL release",
  );
  await page.keyboard.press("Control");
  await page.waitForTimeout(100);
  assert(
    !(await read(() => window.__NOL.game.scene.getScene("Survival").crouching)),
    "CTRL toggles back to standing",
  );
  ...
  await page.screenshot({ path: "output/playwright/v3-inventory.png" });
  ...
  await page.waitForTimeout(250);
  await page.screenshot({ path: "output/playwright/v3-bunker.png" });
  assert(
    await read(() => {
      const s = window.__NOL.game.scene.getScene("Survival");
      return (
  ...
  await page.screenshot({ path: "output/playwright/v3-combat.png" });
  await page.evaluate(() => {
    const s = window.__NOL.game.scene.getScene("Survival");
  ...
  await page.screenshot({ path: "output/playwright/v3-swamp.png" });
  await page.evaluate(() => {
    const s = window.__NOL.game.scene.getScene("Survival");
  ...
  await page.waitForTimeout(350);
  await page.screenshot({ path: "output/playwright/v3-lake.png" });
